...
//        c.drawBitmap(BitmapFactory.decodeFile(Uri.parse("android.resource://" + R.class.getPackage().getName() + "/" + R.drawable.ic_delete_forever_white_24dp).toString()),
//                button.centerX()-(textWidth/2), button.centerY()+(textSize/2), p);
